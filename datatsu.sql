...
-- Database: `datatsu`
--
CREATE DATABASE IF NOT EXISTS `datatsu` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `datatsu`;
...
INSERT INTO `post_table` (`postNumber`, `userId`, `postType`, `postTitle`, `message`, `viewer`, `datetime`) VALUES
...
INSERT INTO `user_table` (`userId`, `password`, `category`, `position`, `salutation`, `datetime`) VALUES
('1', '1', 'User', 'Dean', 'Eng.', '2014-03-04 17:40:36'),
('12345', '12345', 'Faculty', 'Faculty', '', '2014-03-01 04:45:56'),
('2007100163', '12345', 'Student', 'Student', '', '2014-03-04 18:57:34'),
('2009100149', 'adam', 'Student', 'Student', '', '2014-03-01 03:31:48'),
('2013103677', 'jane', 'Student', 'Student', '', '2014-03-04 15:04:59'),
('2014', 'admin', 'User', 'President', 'Mr.', '2014-03-01 04:44:55');
...
INSERT INTO `validation_table` (`userId`, `firstName`, `lastName`, `middleName`, `college`, `yearLevel`) VALUES
