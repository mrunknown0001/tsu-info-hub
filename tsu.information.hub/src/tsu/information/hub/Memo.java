...
private TextView memodatetime;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        postMessage = (TextView) findViewById(R.id.memopost);
        memotitle = (TextView) findViewById(R.id.memotitle);
        memodatetime = (TextView) findViewById(R.id.memodatetime);
	...
	private void Message() {
		...
		nameValuePairs.add(new BasicNameValuePair("type", "Memo"));
		
		try
    	{
			HttpClient httpclient = new DefaultHttpClient();
	        HttpPost httppost = new HttpPost("http://192.168.1.100/tsuih/memo.php");
