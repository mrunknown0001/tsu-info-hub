...
public class WhatsNew extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        posttitle = (TextView) findViewById(R.id.whatsnewtitle);
        postdatetime = (TextView) findViewById(R.id.whatsnewdatetime);
    	whatsnewpost = (TextView) findViewById(R.id.whatsnewpost);
	...
	private void Message() {
		...
		nameValuePairs.add(new BasicNameValuePair("type", "Whats New?"));
		
		try
    	{
			HttpClient httpclient = new DefaultHttpClient();
	        HttpPost httppost = new HttpPost("http://192.168.1.100/tsuih/whatsnew.php");
        ...
        catch(Exception e)
	{
		...
		try
    	{
            ...
            if (viewer.equals("All")) {
            	...
            	whatsnewpost.setText(message);
            	
            	String date = "Date Posted: " + (json_data.getString("datetime"));
            	postdatetime.setText(date);
