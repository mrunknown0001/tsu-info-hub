...
public class DateOfGrad extends Activity {
	
	private TextView postMessage;
	private TextView dogtitle;
	private TextView dogdatetime;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dateofgrad);
        
        	dogtitle = (TextView) findViewById(R.id.dogtitle);
        	dogdatetime = (TextView) findViewById(R.id.dogdatetime);
        	postMessage = (TextView) findViewById(R.id.dateofgradpost);
	...
	private void Message() {
		...
		nameValuePairs.add(new BasicNameValuePair("type", "Date of Graduation"));
		
		try
    	{
			HttpClient httpclient = new DefaultHttpClient();
	        HttpPost httppost = new HttpPost("http://192.168.1.100/tsuih/dateofgraduation.php");
