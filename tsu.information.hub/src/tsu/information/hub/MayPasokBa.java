...
public class MayPasokBa extends Activity {
	
	private TextView postMessage;
	private TextView mpbtitle;
	private TextView mpbdatetime;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.maypasokba);
        
        
        postMessage = (TextView) findViewById(R.id.maypasokbapost);
        mpbtitle = (TextView) findViewById(R.id.mpbtitle);
        mpbdatetime = (TextView) findViewById(R.id.mpbdatetime);
	...
	private void Message() {
		...
		nameValuePairs.add(new BasicNameValuePair("type", "May Pasok ba?"));
		
		try
    	{
			HttpClient httpclient = new DefaultHttpClient();
	        HttpPost httppost = new HttpPost("http://192.168.1.100/tsuih/maypasokba.php");
